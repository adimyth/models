...
DEFAULT_DATASET_DIR = 'datasets/data/number_plates'
...
DEFAULT_CONFIG = {
    ...
    'splits': {
        'train': {
            'size': 10500, # change according to your own train-test split
            'pattern': 'train.tfrecord'
        },
        'test': {
            'size': 2737, # change according to your own train-test split
            'pattern': 'test.tfrecord'
        }
    },
    'charset_filename':
        'charset-labels.txt',
    'image_shape': (450, 100, 3), # (max_width, max_height, 3),
    'num_of_views':
        1,
    'max_sequence_length':
        20, # TO BE CONFIGURED
